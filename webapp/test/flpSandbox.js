		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OUP VAT Claim Report",
									"targetURL": "#ouprtrvatclaimreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ouprtrvatclaimreport-display": {
								"semanticObject": "ouprtrvatclaimreport",
								"action": "display",
								"description": "OUP VAT Claim Report application.",
								"title": "OUP VAT Claim Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.rtr.vatclaimreport",
									"url": sap.ui.require.toUrl("oup/rtr/vatclaimreport")
								}
							}
						}
					}
